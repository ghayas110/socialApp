...
const CheckIn = ({ onLogin }) => {
  ...
  const styles = StyleSheet.create({
    ...
    CheckInHeading: {
      ...
      fontSize: ResposiveSize(18),
      color: 'white',
      paddingBottom: ResposiveSize(10)
    },
    haveAccoundWrapper: {
      flexDirection: 'row',
      alignItems: 'center',
      paddingTop: windowHeight * 0.015,
      paddingHorizontal: ResposiveSize(30),
      position: 'absolute',
      bottom: ResposiveSize(30)
    },
  })
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.bodyWrapper}>
          ...
          <View style={styles.contentWrapper}>
            <TextC text={'Would you like to check in ?'} style={{ color: 'white', textAlign: 'center' }} size={ResposiveSize(18)} font={"Montserrat-SemiBold"} />
            <View style={{ paddingVertical: ResposiveSize(20) }}>
          ...
          <View style={styles.haveAccoundWrapper}>
            <TextC text={'Your CheckIn preference can be changed at any time in Settings.'} style={{ color: 'white', textAlign: 'center' }} size={ResposiveSize(11)} font={"Montserrat-Regular"} />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
