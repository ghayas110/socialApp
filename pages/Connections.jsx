import { StyleSheet, SafeAreaView, StatusBar, View, TouchableOpacity, Dimensions, Pressable } from 'react-native'
...
const Connections = ({ route }) => {
    ...
    const TabContent = () => {
        switch (tabSlider) {
            case 1:
                return <AllConnections page={allEventPage} pageChange={useAllEventPage} />;
            case 2:
                return <PendingConnections page={joinedEventPage} pageChange={useJoinedEventPage} tabActivator={tabActivator} />;
            default:
                return null;
        }
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.wrapper}>
                ...
                <View style={styles.logoSide2}>
                    <TextC size={ResponsiveSize(16)} font={'Montserrat-Bold'} text={"Connection"} />
                </View>
            ...
            <View style={styles.bodyWrapper}>
                <View style={styles.tabWrapper}>
                    <View style={styles.TabSlider}>
                        ...
                        >
                            <TextC text={tabSlider == 1 ? 'All Connections' : tabSlider == 2 ? 'Pending' : ""} style={{ color: "white" }} font={'Montserrat-Medium'} size={ResponsiveSize(11)} />
                        </Animated.View>
                        <TouchableOpacity onPress={() => { tabActivator(1) }} style={styles.TopTab}>
                            <TextC text={'All Connections'} font={'Montserrat-Medium'} size={ResponsiveSize(11)} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => { tabActivator(2) }} style={styles.TopTab}>
                            <TextC text={'Pending'} font={'Montserrat-Medium'} size={ResponsiveSize(11)} />
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
