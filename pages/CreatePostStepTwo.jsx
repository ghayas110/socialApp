    ...
    return (
        <>
            {loading ?
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: global.white, position: 'relative' }}>
                    ...
                    <View style={styles.singlePostContainer}>
                        {route?.params?.isMultiple == true ?
                            <Carousel
                                ...
                                renderItem={(items) =>
                                    <ImageBackground style={styles.singlePostInnerCarousel} source={{ uri: `file://${items.item?.content}` }} />
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('TagPeople')} style={styles.SettingList}>
                        <View style={{ flexDirection: "row", alignItems: 'center' }}>
                            <AntDesign name="adduser" color={global.primaryColor} size={ResponsiveSize(28)} />
                            <TextC text={"Tag People"} font={"Montserrat-Medium"} size={ResponsiveSize(12)} style={{ color: global?.placeholderColor, marginLeft: ResponsiveSize(5) }} />
                        </View>
                        <View>
                            <AntDesign name="right" color={global.primaryColor} size={ResponsiveSize(18)} />
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.SettingList}>
                        ...
                        >
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                                <View style={{ flexDirection: "row", alignItems: 'center' }}>
                                    <AntDesign name="user" color={global.primaryColor} size={ResponsiveSize(28)} />
                                    <TextC text={"Audience"} font={"Montserrat-Medium"} size={ResponsiveSize(12)} style={{ color: global?.placeholderColor, marginLeft: ResponsiveSize(5) }} />
                                </View>
                                <View>
                                    <TextC text={privacy} font={"Montserrat-Medium"} size={ResponsiveSize(10)} style={{ color: global?.placeholderColor, marginLeft: ResponsiveSize(5), backgroundColor: global.description, paddingHorizontal: ResponsiveSize(10), paddingVertical: ResponsiveSize(5), borderRadius: ResponsiveSize(30) }} />
                                </View>
                            </View>
                        </ModalSelector>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => navigation.navigate('PostSetting')} style={styles.SettingList}>
                        <View style={{ flexDirection: "row", alignItems: 'center' }}>
                            <Ionicons name="settings-outline" color={global.primaryColor} size={ResponsiveSize(28)} />
                            <TextC text={"Advance Settings"} font={"Montserrat-Medium"} size={ResponsiveSize(12)} style={{ color: global?.placeholderColor, marginLeft: ResponsiveSize(5) }} />
                        </View>
                        <View>
                            <AntDesign name="right" color={global.primaryColor} size={ResponsiveSize(18)} />
                        </View>
